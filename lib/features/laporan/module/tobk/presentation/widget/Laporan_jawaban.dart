...
import 'package:gokreasi_new/features/laporan/module/tobk/presentation/widget/laporan_detail_jawaban_chart.dart';
import '../../../../../../core/config/extensions.dart';

class LaporanTryoutJawaban extends StatelessWidget {
  final List<LaporanTryoutJawabanModel> _list;
  final String namaTOB;

  const LaporanTryoutJawaban(this._list, this.namaTOB, {super.key});
                ...
                child: Column(
                  ...
                  children: <Widget>[
                      ...
                      children: <Widget>[
                        ...
                        if (_list[i].nilai != null) ...[
                          ...
                          Container(
                            ...
                            child: Text('Skor: ${_list[i].nilai.toString()}',
                                style: context.text.labelLarge),
                          ),
                        ],
                      ],
                    ...
                    Row(
                      ...
                      children: [
                        Expanded(
                          child: DetailJawabanChart(listJawaban: _list[i]),
                        ),
                      ],
                    ),
                    Padding(
