...
class DetailJawabanChart extends StatefulWidget {
  final LaporanTryoutJawabanModel listJawaban;
  const DetailJawabanChart({Key? key, required this.listJawaban})
      : super(key: key);

  @override
  State<DetailJawabanChart> createState() => _DetailJawabanChartState();
}

class _DetailJawabanChartState extends State<DetailJawabanChart> {
