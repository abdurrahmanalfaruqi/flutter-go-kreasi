...
class LogAktivitasHarian extends StatefulWidget {
  const LogAktivitasHarian({super.key});

  @override
  State<LogAktivitasHarian> createState() => _LogAktivitasHarianState();
}

class _LogAktivitasHarianState extends State<LogAktivitasHarian> {
        ...
        return SingleChildScrollView(
          child: SizedBox(
            ...
            child: BasicEmpty(
              ...
              title: 'Laporan Aktivitas',
              emptyMessage:
                  "Sobat belum membaca, menonton video dan mengerjakan soal hari ini, ayo mulai belajar Sobat!",
              subTitle: "Data tidak ditemukan",
            ),
          ),
        );
  ...
  /// [buildWaktu] widget untuk menampilkan waktu aktivitas.
  ///
  /// Args:
