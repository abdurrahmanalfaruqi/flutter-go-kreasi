...
class _CustomProgressBarState extends State<CustomProgressBar>
  ...
  @override
  void didUpdateWidget(CustomProgressBar old) {
    triggerAnimation();
...
class AnimatedProgressBar extends AnimatedWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.displayText != null && animation.value > 0.25) {
    ...
    double jumlahSoal = animation.value * widget.maxValue;
    String displayJumlahSoal =
        jumlahSoal.toStringAsFixed(widget.formatValueFixed ?? 0);
              ...
              Expanded(
                ...
                child: Container(
                  child: (animation.value <= 0.25)
                      ? Text(
                          (widget.displayText?.isEmpty ?? true)
                              ? ' $displayJumlahSoal soal'
                              : ' $displayJumlahSoal${widget.displayText}',
                          softWrap: false,
                          style: widget.displayTextStyle,
                        )
                      : null,
